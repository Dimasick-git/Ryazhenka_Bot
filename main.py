...
async def main() -> None:
    ...
    try:
        ...
        await bot.set_my_commands([
            ...
            BotCommand(command="quiz",      description="Тест знаний по Switch CFW (43 вопроса)"),
            ...
            BotCommand(command="howto",     description="Пошаговые руководства (rcm/modchip/emummc/sigpatches/dns)"),
